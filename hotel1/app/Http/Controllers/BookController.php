...
//        header("Location: ".$vpcURL);
    ...
    public function getResponse(Request $request)
    {
        ...
        return view('bookresult', ['transStatus' => $transStatus, "merchantID" => $merchantID, "merchTxnRef" => $merchTxnRef, "orderInfo" => $orderInfo, "amount" => $amount, "txnResponseCode" => $txnResponseCode, "txnResponseDescription" => $this->getResponseDescription($txnResponseCode), "transactionNo" => $transactionNo]);
    }
