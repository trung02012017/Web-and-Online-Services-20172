    ...
    var r = false
      ...
      , F = function(j, c) {
        function h(d, c, f) {
            c = d.css(c);
            d = parseFloat(c);
            return isNaN(d) ? (d = o[c] || 0,
            f = d == 3 ? f ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1,
            b.isie8 && d && (d += 1),
            f ? d : 0) : d
        }
        function i(d, c) {
            var f = 0
              , g = 0
              , e = 1;
            "wheelDeltaY"in d ? (e = b.opt.mousescrollstep / 48,
            f = Math.floor(d.wheelDeltaX * e),
            g = Math.floor(d.wheelDeltaY * e)) : (e = d.detail ? d.detail * -1 : d.wheelDelta / 40) && (c ? f = Math.floor(e * b.opt.mousescrollstep) : g = Math.floor(e * b.opt.mousescrollstep));
            f && (b.scrollmom && b.scrollmom.stop(),
            b.lastdeltax += f,
        ...
        this.init = function() {
            ...
            if (!b.ispage || !g.cantouch && !g.isieold && !g.isie9mobile) {
                ...
                b.rail = f;
                c = b.rail.drag = false;
                if (b.opt.boxzoom && !b.ispage && !g.isieold && (c = document.createElement("div"),
                ...
                if (b.opt.autohidemode === false)
                    ...
                    if (b.autohidedom = e().add(b.cursor),
                    b.railh)
                ...
                if (g.isie9mobile)
                    ...
                    b.onmangotouch = function() {
                        ...
                        if (Math.round(Math.sqrt(Math.pow(l, 2) + Math.pow(f, 2))) != 0) {
                            ...
                            b.scrollmom.update(b.mangotouch.sx - l, b.mangotouch.sy - f),
                            b.mangotouch.tm = h,
                        ...
                        b.ontouchmove = function(d, c) {
                            ...
                            if (b.rail.drag && b.rail.drag.pt == 2) {
                                ...
                                b.synched("touchmove", function() {
                                    ...
                                    b.railh && b.railh.scrollable ? (b.setScrollLeft(j),
                                    b.showCursor(i, j)) : b.showCursor(i),
                    ...
                    b.onclick = g.isios ? false : function(d) {
                        return b.lastmouseup ? (b.lastmouseup = false,
                        b.cancelEvent(d)) : true
                    }
                    ,
                    b.onmousemove = b.ontouchmove,
                    g.cursorgrabvalue && (b.css(b.ispage ? b.doc : b.win, {
                    ...
                    b.opt.enablemousewheel && (b.isiframe || b.bind(g.isie && b.ispage ? document : b.docscroll, "mousewheel", b.onmousewheel),
            ...
            if (this.doc[0].nodeName == "IFRAME") {
                var A = function() {
                    ...
                    b.zoom && (b.opt.dblclickzoom && b.bind(d, "dblclick", b.doZoom),
        ...
        this.bind = function(d, c, f, e) {
            ...
            g.cantouch && c == "mouseup" && b._bind(h, "touchcancel", f, e || false)) : b._bind(h, c, function(d) {
        ...
        this.doScrollPos = function(c, e) {
            ...
            var g = b.getScrollTop()
              , h = b.getScrollLeft();
            ((b.newscrolly - g) * (e - g) < 0 || (b.newscrollx - h) * (c - h) < 0) && b.cancelScroll();
            b.newscrolly = e;
            b.newscrollx = c;
        ...
        this.doZoomIn = function(c) {
            if (!b.zoomactive) {
                ...
                var h = "position,top,left,zIndex,backgroundColor,marginTop,marginBottom,marginLeft,marginRight".split(","), f = b.win[0].style, i;
                for (i in h) {
                    var j = h[i];
            ...
            if (c.speedy && b && c.speedy || e) {
                ...
                var d = c.lastscrollx
                  ...
                  , f = function() {
                    ...
                    if (c.speedx && (d = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)),
                    c.lastscrollx = d,
                    d < 0 || d > m))
                        b = 0.1;
                    ...
                    c.demulxy < 1 ? c.timer = setTimeout(f, o) : (c.stop(),
                    c.nc.hideCursor(),
                    c.doSnapy(d, l))
                };
                f()
