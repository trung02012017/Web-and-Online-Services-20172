...
function updateAbOver() {
    $(document).ready(function() {
        ...
        $(".abover").mouseenter(function() {
            $(this).find('.abbg').stop().animate({
                'left': 0 + 'px'
            }, 500);
...
jQuery(document).ready(function($) {
    ...
    $(window).scroll(function() {
        ...
        if ($iw < 992) {
            ...
            $('.navbar-wrapper2').css({
                'min-height': 110 - ($scrollTop / 2) + 'px'
            });
        }
        $('#dajy').css({
            'top': ((-$scrollTop / 5) + $headerheight) + 'px'
        });
        ...
        $(".tp-leftarrow").css({
            'left': 20 - ($scrollTop / 2) + 'px'
        });
        $(".tp-rightarrow").css({
            'right': 20 - ($scrollTop / 2) + 'px'
        });
    });
